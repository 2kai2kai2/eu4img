...
file_dir = os.path.join("resources", input("Target name: "))

saveFile = open(os.path.join(file_dir, "save_1444.eu4"),
                "r", encoding="cp1252")
...
writeFile = open(os.path.join(file_dir, "tagCapitals.txt"),
                 "w", encoding="cp1252")
writeString = ""
